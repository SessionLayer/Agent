...
impl MsgType {
    fn from_u8(v: u8) -> Option<Self> {
        ...
        // and MUST be rejected as protocol errors until they are defined; falling
        // through to `None` is exactly that.
        Some(match v {
            0x01 => Self::Hello,
            0x02 => Self::HelloAck,
...
pub fn decode(
    ...
    // with trailing garbage are both protocol errors.
    ...
    Ok(match ty {
        ...
        // Opaque: never parsed, never inspected, never logged.
